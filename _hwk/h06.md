...
<ol>
<li style="margin-bottom:6em;" > (10 pts) Remind us of the 1-sentence description of your product.
</li>

<li style="margin-bottom:8em;" > (10 pts) Write the user story you have chosen (in the form of as a/an x I can y so that z)
</li>
...
<li style="margin-bottom:6em;" > (10 pts) Write the user story you have chosen (in the form of as a/an x I can y so that z).  It should be a different story from the one chosen above.
</li>


<li style="margin-bottom:6em;" > (10 pts) Write the rule that your pair of acceptance tests will illustrate.
  
</li>


<li style="margin-bottom:1em;" > (20 pts) Using the GIVEN-WHEN-THEN format illustratd in <http://bit.ly/cs48-w19-h06-article>,
