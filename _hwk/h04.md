...
<li style="margin-bottom:8em;" markdown="1"> (9 pts) What are three examples of Agile methodologies?  You can just name them; you don't have to explain each in detail.

</li>

<li style="margin-bottom:8em;" markdown="1"> (6 pts) What makes these (the answers to your previous question) methodologies rather than part of the Agile Mindset?
...
<ol>
<li> (5 pts) Value of processes and tools
</li>

<li> (5 pts) Value of comprehensive documentation
</li>

<li> (5 pts) Value of contract negotiation
</li>

<li> (5 pts) Value of following a plan
</li>
...
<li markdown="1"> (10 pts) Now suppose you were asked to choose one of the four statements, and present an argument that while the item on the right has value (as you argued above), the value on the left has *more* value.  What would you say in support of this position?
